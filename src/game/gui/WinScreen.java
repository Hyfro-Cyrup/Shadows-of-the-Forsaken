...
public class WinScreen extends JPanel {
     ...
     */
    public WinScreen(SceneSwitcher parent) {
            ...
            try
            {
                backgroundImage = ImageIO.read(this.getClass().getResource("/resources/WinScreenBackground.png"));
    ...
    protected void paintComponent(Graphics g) {
        ...
        String winMessage = "Congratulations! You escaped!";
